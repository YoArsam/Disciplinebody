                  ...
                  <div className="mt-5 pt-4 border-t border-gray-100">
                    <div className="bg-white rounded-2xl p-6 border border-gray-200 text-center animate-fadeIn">
                      ...
                      <p className="text-gray-500 text-xl font-bold leading-tight px-2">
                        You will give <span className="text-gray-900 font-black text-2xl">${(skipCost !== null ? skipCost : (parseFloat(customAmount) || 0)).toFixed(2)}</span> to charity if you skip this habit
                      </p>
