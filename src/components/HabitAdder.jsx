                ...
                {(skipCost !== null || showCustomInput) && (
                  <div className="mt-8 pt-6 border-t border-gray-100">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-[2rem] p-8 text-center shadow-xl shadow-blue-100 animate-fadeIn">
                      ...
                      <p className="text-white text-2xl font-black leading-tight text-center">
                        You'll give <span className="text-3xl">\${(skipCost !== null ? skipCost : (parseFloat(customAmount) || 0)).toFixed(2)}</span> to charity for every missed day
                      </p>
                    </div>
                  </div>
                )}
