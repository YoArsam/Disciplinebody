...
function HabitAdder({ habit, onSave, onDelete, onBack }) {
  ...
  const [habitTime, setHabitTime] = useState(habit?.habitTime || '09:00') // HH:mm or empty
  const [hasDeadline, setHasDeadline] = useState(!!(habit?.habitTime))
  ...
  const canGoNext = () => {
    ...
    if (step === 2) return !hasDeadline || !!habitTime
  ...
  const handleSubmit = (e) => {
    ...
    onSave({
      ...(habit || {}),
      name: name.trim(),
      deadline: hasDeadline ? habitTime : '',
      habitTime: hasDeadline ? habitTime : '',
              ...
              <div className="space-y-4">
                <div className="flex gap-2">
                  <button
                    ...
                    onClick={() => {
                      setHasDeadline(true)
                      if (!habitTime) setHabitTime('09:00')
                    }}
                ...
                {!isEditing && (skipCost !== null || showCustomInput) && (
                  <div className="mt-4 pt-4 border-t border-gray-100 animate-fadeIn">
                    <div className="bg-blue-50/30 rounded-2xl p-6 border border-blue-100 text-center">
                      ...
                      <p className="text-gray-500 text-2xl font-bold leading-tight px-2">
