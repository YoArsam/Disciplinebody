  ...
  if (showPayment) {
    return (
      <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex flex-col items-center justify-center z-50 px-6">
        <div className="bg-white rounded-3xl p-8 shadow-2xl w-full max-w-sm flex flex-col items-center">
          ...
          <button
            onClick={onNo}
            className="w-full bg-black text-white font-semibold py-4 rounded-2xl active:scale-[0.98] transition-transform shadow-lg"
          >
            Pay with Apple Pay
          </button>
        </div>
    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex flex-col items-center justify-center z-50 px-6">
      <div className="bg-white rounded-3xl p-8 shadow-2xl w-full max-w-sm flex flex-col items-center">
        ...
        <div className="w-full space-y-3">
          <button
            onClick={onYes}
            className="w-full bg-green-500 text-white font-semibold py-4 rounded-2xl active:scale-[0.98] transition-transform shadow-lg shadow-green-500/20"
          >
            Yes, I did it! ✓
          </button>
